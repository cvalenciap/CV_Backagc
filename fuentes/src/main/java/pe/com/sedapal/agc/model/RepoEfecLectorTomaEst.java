...
public class RepoEfecLectorTomaEst {
	...
	public RepoEfecLectorTomaEst(String v_idcarga, String ciclo, String v_descofic, String cod_lector, String lector,
			String v_nombreempr, String periodo, BigDecimal carga_entrega, BigDecimal lecturas, BigDecimal incidencias,
			BigDecimal supervisadas, BigDecimal porc_lecturas, BigDecimal porc_incidencias,
			BigDecimal porc_supervisadas, BigDecimal con_dispositivo_movil, BigDecimal con_hoja_ruta) {
		super();
